    ...
    priceDiscount: {
      ...
      validate: {
        validator: function(val) {
          // not working on update... this only points to current doc on NEW document creation
...
// we can use multiply middleware hooks
// tourSchema.pre('save', function(next) {
//   console.log('Document will be saved!');
//   next();
// });

// Executed after all pre functions are completed
...
// QUERY MIDDLEWARE
// for find all and one we use regular expression
