        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Successful login!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8000/api/v1/usersupdateMyPassword' : 'http://localhost:8000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var userPasswordForm = docuemnt.querySelector('.form-user-password'); // DELEGATION
...
if (userPasswordForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var passwordCurrent = password.getElementById('password-current').value;
    var password = password.getElementById('password').value;
    var passwordConfirm = password.getElementById('password-confirm').value; //const email = document.getElementById('email').value;
